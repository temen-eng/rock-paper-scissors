...
Step 1: Setup the project structure
    ...
    Create a new Git repository for your project. done
    Create a blank HTML document with a script tag. done
    Check if JavaScript is linked correctly: done
        Write console.log("Hello World") in JavaScript. done
        Check if “Hello World” is logged in the browser console once you open your webpage. done

It’s best practice to link to an external JavaScript file inside this script tag. Using an external JavaScript file keeps your HTML file clean and organized. done
